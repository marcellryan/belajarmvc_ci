...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->menuModel->insertMenu(['menu' => $this->input->post('menu')]);
    ...
    public function delete($id)
    {
        ...
        $this->session->set_flashdata(
            'message',
            '<div class="alert alert-success" role="alert">Menu was Deleted!</div>'
        );
        redirect('menu');
    }
    ...
    public function update($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata(
                'message',
                '<div class="alert alert-success" role="alert">Menu was updated!</div>'
            );
            redirect('menu');
        }
    }
    ...
    public function submenu()
{
    ...
    if ($this->form_validation->run() == false) {
        ...
        $this->menuModel->insertSubmenu($submenuData);
    ...
    public function deleteSubMenu($id)
    {
        ...
        $this->session->set_flashdata(
            'message',
            '<div class="alert alert-success" role="alert">Sub menu was Deleted!</div>'
        );
        redirect('menu/submenu');
    }
    ...
    public function updateSubMenu($id)
{
    ...
    if ($this->form_validation->run() == false) {
        ...
        $this->menuModel->updateSubmenu($updatedData, $id);
